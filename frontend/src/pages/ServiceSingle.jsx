      ...
      <Box bg="white" minH="100vh" pt={{ base: "90px", md: "100px" }} pb={{ base: 8, md: 12 }}>
        <Container maxW="7xl" px={{ base: 4, md: 6, lg: 8 }}>
          ...
          {Array.isArray(detailsSections) && detailsSections.length > 0 && (
            <Box py={{ base: 8, md: 12 }} >
              <Box bg="gray.50" borderRadius="2xl" p={{ base: 5, md: 8 }}>
                <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={{ base: 5, md: 6 }} gap={5} >
                  {detailsSections.map((section, idx) => (
                    <Box
                      ...
                      boxShadow="sm"
                    >
                      <Heading as="h1" size="md" mb={3} color="gray.900" fontSize={{ base: "lg", md: "xl" }}>
                        {section.title}
                      </Heading>
          ...
          <Box py={{ base: 8, md: 12 }} bg="gray.50">
            ...
            <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={{ base: 6, lg: 8 }} gap={5}>
